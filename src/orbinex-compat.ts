...
class UniverseEngine {
    ...
    private initializeBodies(): void {
        ...
        const planetDefs: Array<[string, UniverseBodyKind, number, number, number, number, string, string, boolean, number]> = [
            ...
            ["Mimas", "moon", 3.7493e19, 1.981e5, 1.8554e8 / constants.auMeters, 0.942, "#d9d5cd", "Saturnus", false, 1.57],
            ["Tethys", "moon", 6.174e20, 5.31e5, 2.9466e8 / constants.auMeters, 1.888, "#e0ddd4", "Saturnus", false, 1.09],
            ["Dione", "moon", 1.095e21, 5.612e5, 3.774e8 / constants.auMeters, 2.737, "#d6d2ca", "Saturnus", false, 0.03],
            ["Amalthea", "moon", 2.08e18, 8.35e4, 1.814e8 / constants.auMeters, 0.498, "#cfae87", "Jupiter", false, 0.37],
            ["Himalia", "moon", 6.7e18, 8.5e4, 1.146e10 / constants.auMeters, 250.57, "#b8b2a4", "Jupiter", false, 27.5],
            ["Elara", "moon", 8.7e17, 4.3e4, 1.174e10 / constants.auMeters, 259.65, "#9f9d99", "Jupiter", false, 26.6],
            ["Phobos", "moon", 1.0659e16, 1.1267e4, 9.376e6 / constants.auMeters, 0.319, "#a08f82", "Mars", false, 1.1],
            ["Deimos", "moon", 1.476e15, 6.2e3, 2.346e7 / constants.auMeters, 1.263, "#988c83", "Mars", false, 1.8],
            ["Titania", "moon", 3.527e21, 7.889e5, 4.363e8 / constants.auMeters, 8.706, "#c7cfde", "Uranus", false, 0.34],
            ["Oberon", "moon", 3.014e21, 7.614e5, 5.835e8 / constants.auMeters, 13.463, "#b4bbc8", "Uranus", false, 0.1],
            ["Triton", "moon", 2.14e22, 1.353e6, 3.5476e8 / constants.auMeters, 5.877, "#b8d3df", "Neptunus", false, 130.0],
